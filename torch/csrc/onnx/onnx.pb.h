...
#define onnx_TensorProto_init_default                                          \
  {                                                                            \
    {{NULL}, NULL}, false, (onnx_TensorProto_DataType)0, false,                \
        onnx_TensorProto_Segment_init_default, {{NULL}, NULL}, {{NULL}, NULL}, \
...
#define onnx_TensorProto_init_zero                                          \
  {                                                                         \
    {{NULL}, NULL}, false, (onnx_TensorProto_DataType)0, false,             \
        onnx_TensorProto_Segment_init_zero, {{NULL}, NULL}, {{NULL}, NULL}, \
        {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL},     \
        {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, {                   \
      {NULL}, NULL                                                          \
    }                                                                       \
