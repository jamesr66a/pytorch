...
void interpTest() {
    ...
    Code  lstm_function(lstm_g, /*computes_on_variables=*/false);
    std::vector<at::Tensor> outputs;
...
std::pair<tensor_list, tensor_list> runGradient(Gradient& grad_spec,
  ...
  Code f_code { grad_spec.f,  /*computes_on_variables=*/false }, df_code { grad_spec.df,  /*computes_on_variables=*/false };
